            ...
            <div class="card p-4">
                ...
                <div class="card-body">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder mb-0">Input SDM Logistik</h6>
                    </nav>

                    {{--  form  --}}
                    <form id="form" action="/kurir/store" method="POST" style="color: black">
                        @csrf
                        <div class="form-group" >
                          <label style="color: black" for="exampleFormControlInput1">Nama</label>
